...
<body class="bg-light">
  ...
  <div class="container mt-4">
    <h2 class="mb-4"><i class="fas fa-user-plus me-2"></i>Tambah User</h2>
    @if($errors->any())
      ...
      <div class="card-body">
        <form method="POST" action="{{ url('user-admin') }}">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_user" name="nama_user" required value="{{ old('nama_user') }}">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email_user" name="email_user" required value="{{ old('email_user') }}" placeholder="user@students.unnes.ac.id">
            <div class="form-text">Hanya boleh email @students.unnes.ac.id</div>
          </div>
          <div class="mb-3">
            <label for="no_telepon" class="form-label">No Telepon</label>
            <input type="text" class="form-control" id="no_telepon" name="no_telepon" required value="{{ old('no_telepon') }}">
          </div>
          <div class="mb-3">
